...
${class}    //button[@class="btn btn-modal-close btn-link"]
${pending}    (//select[@data-fieldname="status"])[1]
${enter}    (//select[@data-fieldname="status"])[1]
${wait3}    //a[@data-name="MR-23-00033"]
${mrid}    //a[@data-name="MR-23-00033"]
...
${xicon}    (//button[@data-dismiss="modal"])[1]
...
${link}    //a[@data-name="MR-23-00026"]
${class2}    (//button[@class="btn btn-modal-close btn-link"])[1]
...
${xicon1}    (//button[@data-dismiss="modal"])[1]
...
${row1}    (//div[@class="row-index sortable-handle col"])[4]
